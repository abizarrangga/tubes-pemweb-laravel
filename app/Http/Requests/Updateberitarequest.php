...
class UpdateBeritaRequest extends FormRequest
{
    ...
    /**
     * Aturan validasi untuk MEMPERBARUI berita.
     * Perbedaan utama dari Store: gambar tidak wajib (sudah ada yang lama).
     */
    public function rules(): array
    {
        return [
            ...
            // File gambar nullable — jika tidak diupload, pakai gambar lama
